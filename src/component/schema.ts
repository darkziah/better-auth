...
//
// NOTE: In "same-schema mode", organization plugin tables (organization,
// member, invitation, team, teamMember) are intentionally NOT defined here.
// They live in the root app schema via `getConvexAuthTables()`. Do NOT add
// org tables to this file — doing so would create duplicate table definitions.
// See: src/client/plugin-schemas.ts and src/client/get-convex-auth-tables.ts
